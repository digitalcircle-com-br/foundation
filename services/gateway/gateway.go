...
// 			return
// 		}
// 		logrus.Infof("Routing: %s to %s:%s", originalUrl, route.Dst, r.URL.String())
...
// 		logrus.Infof("Adding route: %s", route.String())
// 		SetupRoute(route)
// 	}
...
// 		logrus.Infof("Routing: %s to %s => %s", originalUrl, q, r.URL.String())
...
// 		logrus.Infof("Routing: %s  => %s (%s)", originalUrl, r.URL.String(), r.RequestURI)
...
// 		logrus.Debugf("No routes set yet for gateway")
// 		http.NotFound(w, r)
// 	})
