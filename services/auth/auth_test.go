...
// 	assert.NoError(t, err)
// 	ctx := context.WithValue(context.Background(), fmodel.COOKIE_SESSION, sess)
// 	ctx = context.WithValue(ctx, fmodel.CTX_SESSION, sess)
// 	res, err := auth.Service.Check(ctx, &fmodel.EMPTY{})
// 	assert.NoError(t, err)
// 	assert.True(t, res)
// }
...
// 	ctx := context.WithValue(context.Background(), fmodel.COOKIE_SESSION, sess)
// 	ctx = context.WithValue(ctx, fmodel.CTX_SESSION, sess)
// 	res, err := auth.Service.Logout(ctx, &fmodel.EMPTY{})
// 	assert.NoError(t, err)
// 	assert.True(t, res)
// }
